...
urlpatterns = [
    ...
    path('employee_rating/', permission_required('reporting')(views.employee_rating), name='employee_rating'),
    path('employee_rating_all/', permission_required('reporting')(views.employee_rating_table), name='employee_rating_all'),
    path('subdivision_rating/', permission_required('reporting')(views.subdivision_rating), name='subdivision_rating'),
    path('subdivision_rating_all/', permission_required('reporting')(views.subdivision_rating_table), name='subdivision_rating_all'),
