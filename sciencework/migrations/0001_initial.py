    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_vak', models.BooleanField(blank=True, null=True, verbose_name='В ВАК')),
                ('in_international', models.ManyToManyField(blank=True, to='sciencework.InternationalBase', verbose_name='Международная база научного цитирования')),
            ],
            options={
                'verbose_name': 'Журнал',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('half_year', models.CharField(default='Не указано', max_length=10, verbose_name='Полугодие')),
                ...
                ('other_author_count', models.IntegerField(blank=True, default=0, null=True, verbose_name='Количество сторонних авторов')),
                ...
                ('in_internationals', models.ManyToManyField(blank=True, to='sciencework.InternationalBase', verbose_name='Входит в международную базу научного цитирования')),
                ('interest', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sciencework.Interest', verbose_name='В чьих интересах')),
